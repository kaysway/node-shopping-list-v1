...
// adding some recipes to 'Recipes' so there
// are some recipe results to look at
Recipes.create('spaghetti'['hamburger', 'noodles', 'sauce']);
Recipes.create('quiche'['eggs', 'flour', 'peppers']);
